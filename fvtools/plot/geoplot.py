...
class geoplot():
    ...
    not active:
    source:     intended to change source of background map.
    '''
    def __init__(self, x, y, ll=False, projection = 'epsg:32633',
                 source = 'wiki', verbose = False):
        # Projections
        ...
        #src    = ctx.providers.Thunderforest.Landscape
